...
#plt.yscale('log')    
plt.plot(x1_fin,y1_fin,'g:',marker='s',markersize=18,linewidth=15.0,label = "Vanilla-MCMC")
plt.plot(x2_fin,y2_fin,'c-.',marker='d',markersize=18,linewidth=15.0, label = "Orbital-MCMC")
plt.plot(x3_fin,y3_fin,'r-.',marker='<',markersize=18,linewidth=15.0, label = "VV-MCMC")
...
plt.xlabel('No of Samples',fontsize=40, labelpad = -2)
plt.ylabel('KL Div. With True Margs.',fontsize=40, labelpad = 0)

plt.errorbar(x1_fin,y1_fin,yerr=e1_fin,ecolor='g',capsize=10, elinewidth=5)
plt.errorbar(x2_fin,y2_fin,yerr=e2_fin,ecolor='c',capsize=10, elinewidth=5)
plt.errorbar(x3_fin,y3_fin,yerr=e3_fin,ecolor='r',capsize=10, elinewidth=5)
...
plt.title(sys.argv[5],fontsize=40,y=1.02)
plt.show()
