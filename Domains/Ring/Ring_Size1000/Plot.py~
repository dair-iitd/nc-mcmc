...
#plt.yscale('log')    
plt.plot(x1_fin,y1_fin,'g:',marker='s',markersize=30,linewidth=15.0,label = "Vanilla-MCMC")
plt.plot(x2_fin,y2_fin,'b-.',marker='d',markersize=20,linewidth=15.0, label = "Orbital-MCMC")
plt.plot(x3_fin,y3_fin,'r-.',marker='<',markersize=20,linewidth=15.0, label = "VV-Orbital-MCMC")
...
plt.errorbar(x1_fin,y1_fin,yerr=e1_fin,ecolor='g',capsize=15, elinewidth=5)
